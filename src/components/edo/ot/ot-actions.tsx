        ...
        {showConfirmModal && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-6 sm:p-12 overflow-hidden">
            ...
            <motion.div
              ...
              className="relative bg-white dark:bg-apple-gray-50 w-full max-w-md rounded-[48px] shadow-2xl overflow-hidden border border-apple-gray-100 dark:border-white/5"
            >
              <div className="p-10 space-y-8">
                ...
                <div className="flex flex-col items-center text-center space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-medium text-apple-gray-400 leading-relaxed mt-2">
