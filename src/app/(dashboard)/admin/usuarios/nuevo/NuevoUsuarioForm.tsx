                ...
                render={({ field }) => (
                  <FormItem className="space-y-4">
                    <div className="flex items-center gap-3 px-2">
                      ...
                      <FormLabel className="text-[10px] font-black text-apple-gray-400 uppercase tracking-widest">Dirección de Email</FormLabel>
                    </div>
                    <FormControl>
                      <Input
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
              <FormField
                ...
                render={({ field }) => (
                  <FormItem className="space-y-4">
                    <div className="flex items-center gap-3 px-2">
                      <FormLabel className="text-[10px] font-black text-apple-gray-400 uppercase tracking-widest">Asignar Rol</FormLabel>
                    </div>
                    ...
                    <FormDescription className="px-4 py-3 bg-apple-blue/5 dark:bg-apple-blue/10 rounded-xl border border-apple-blue/10 text-[10px] font-bold text-apple-blue uppercase leading-relaxed tracking-wider">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem className="space-y-4">
                    ...
                    <FormDescription className="px-4 text-[10px] font-bold text-apple-gray-300 uppercase tracking-widest">
