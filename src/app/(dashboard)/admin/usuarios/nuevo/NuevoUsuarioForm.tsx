      ...
      <div className="p-6 space-y-6">
        ...
        <div>
          ...
          <p className="mt-1 text-xs text-gray-500">
            DO: gestiona obras y usuarios. JO: ejecuta OTs en campo. Compras: gestiona órdenes de compra.
          </p>
        </div>

        {/* Obra (optional, mainly for JO) */}
        <div>
          <label
            htmlFor="obra_id"
            className="block text-sm font-medium text-gray-700 mb-1"
          ...
          <p className="mt-1 text-xs text-gray-500">
            Requerido para Jefes de Obra. Determina qué obra pueden ver.
          </p>
        </div>
      </div>

      {/* Actions */}
      <div className="px-6 py-4 bg-gray-50 border-t border-gray-200 flex flex-col sm:flex-row gap-3 sm:justify-end rounded-b-lg">
        <Link
          href="/admin/usuarios"
