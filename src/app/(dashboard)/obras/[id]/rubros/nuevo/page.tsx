      ...
      <nav className="fixed top-0 left-0 right-0 z-50 px-8 py-6 backdrop-blur-3xl bg-white/70 dark:bg-black/70 border-b border-apple-gray-100 dark:border-white/5 shadow-apple-sm flex items-center justify-between">
        <div className="flex items-center gap-6">
          <button
            ...
            className="w-12 h-12 rounded-full glass dark:glass-dark flex items-center justify-center text-apple-gray-400 hover:text-apple-blue transition-all active:scale-95 group shadow-apple-sm"
          >
            ...
            >
              ...
              >
                ...
                <div className="relative z-10 h-full flex flex-col justify-between">
                  ...
                  <div className="space-y-6">
                    <h3 className="text-5xl font-black text-foreground tracking-tighter leading-none italic uppercase">Smart<br />Templates</h3>
              ...
              >
                ...
                <div className="relative z-10 h-full flex flex-col justify-between">
                  ...
                  <div className="space-y-6">
                    <h3 className="text-5xl font-black text-foreground tracking-tighter leading-none italic uppercase">Configurable<br />Manual</h3>
                    <p className="text-xl text-apple-gray-400 font-medium leading-relaxed max-w-xs">
                      ...
                      {items.map((p, pIdx) => (
                        ...
                        >
                          <div className="space-y-4">
                            ...
                            <div>
                              <h4 className="text-xl font-black text-foreground group-hover:text-apple-blue transition-colors leading-tight italic uppercase tracking-tight">{p.nombre}</h4>
                              <div className="flex items-center gap-2 mt-2">
                                <Box size={14} className="text-apple-gray-200" />
                ...
                <div className="bg-white dark:bg-apple-gray-50 rounded-[56px] p-12 border border-apple-gray-100 dark:border-white/5 shadow-apple-float space-y-12 relative overflow-hidden">
                  ...
                  {mode === 'template' && selectedPlantilla && (
                    <div className="p-8 bg-apple-blue/[0.03] dark:bg-white/[0.02] rounded-[40px] border border-apple-blue/10 flex items-start gap-6 relative z-10">
                      <div className="w-14 h-14 bg-apple-blue text-white rounded-2xl flex items-center justify-center shrink-0 shadow-lg shadow-apple-blue/20">
                        <Smartphone className="w-7 h-7" />
                      </div>
                      <div className="space-y-2">
                        <h4 className="text-lg font-black text-foreground tracking-tight italic uppercase">Herencia Activa</h4>
                        <p className="text-sm text-apple-gray-400 font-medium leading-relaxed">
                          Has seleccionado <span className="text-apple-blue font-black italic">{selectedPlantilla.nombre}</span>. Se importarán automáticamente todos los insumos y ratios de producción asociados.
                        </p>
                      </div>
                    </div>
                  )}
                  ...
                  <div className="space-y-10 relative z-10">
                    <div className="space-y-4">
                      <label className="text-[10px] font-black text-apple-gray-300 uppercase tracking-[0.2em] ml-4 block italic">Identidad del Rubro</label>
                      <input
                        type="text"
                        name="nombre"
                        required
                    ...
                    <div className="grid md:grid-cols-2 gap-10">
                      <div className="space-y-4">
                        <label className="text-[10px] font-black text-apple-gray-300 uppercase tracking-[0.2em] ml-4 block italic">Unidad de Gestión</label>
                        <AppleSelector
                      ...
                      <div className="space-y-4">
                        <label className="text-[10px] font-black text-apple-gray-300 uppercase tracking-[0.2em] ml-4 block italic">Presupuesto Inicial (UR)</label>
                  ...
                  <div className="pt-6 relative z-10">
                    ...
                    <p className="text-center mt-6 text-[9px] font-black text-apple-gray-200 uppercase tracking-[0.3em]">
