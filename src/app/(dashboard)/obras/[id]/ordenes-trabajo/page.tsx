...
export default async function OrdenesTrabajoPage({ params, searchParams }: Props) {
  ...
  return (
    <div className="min-h-screen bg-[#f5f5f7] dark:bg-black p-6 md:p-14 antialiased selection:bg-apple-blue/10">
      {/* Premium Header */}
      <header className="max-w-7xl mx-auto flex flex-col md:flex-row md:items-center justify-between gap-8 mb-16 animate-apple-fade-in">
        <div className="flex items-center gap-6">
          ...
          <div>
            <div className="flex items-center gap-2">
              ...
              <p className="text-[10px] font-black text-apple-gray-300 uppercase tracking-[0.2em]">{obra.nombre}</p>
            </div>
            <h1 className="text-4xl font-black text-foreground tracking-tight">Órdenes de Trabajo</h1>
          </div>
        </div>
        ...
        <div className="flex items-center gap-4">
          <Link
            ...
            className="h-14 px-8 bg-apple-blue text-white rounded-full font-black text-[11px] uppercase tracking-[0.2em] hover:bg-apple-blue-dark transition-all shadow-apple-float active:scale-[0.96] flex items-center gap-3"
          >
      ...
      <main className="max-w-7xl mx-auto space-y-12 pb-32">
        {/* Bento Stats Row */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 animate-apple-slide-up">
          <div className="p-8 bg-white dark:bg-apple-gray-50 rounded-[32px] border border-apple-gray-100 dark:border-white/5 shadow-apple group hover:-translate-y-2 transition-transform duration-500">
        ...
        <section className="animate-apple-slide-up" style={{ animationDelay: '0.2s' }}>
          {otsWithProgress.length > 0 ? (
            <div className="bg-white dark:bg-apple-gray-50 rounded-[40px] border border-apple-gray-100 dark:border-white/5 shadow-apple-float overflow-hidden overflow-x-auto">
                  ...
                  {otsWithProgress.map((ot) => {
                    ...
                    return (
                      ...
                      >
                          ...
                          <div className="flex items-center gap-4">
                            ...
                            <div>
                              <Link
                                ...
                                className="text-lg font-black text-foreground tracking-tighter hover:text-apple-blue transition-colors uppercase italic"
                              >
                                OT-{ot.numero}
                              </Link>
                        ...
                        <td className="px-8 py-8 whitespace-nowrap text-right font-black text-foreground text-lg tracking-tighter italic">
                        ...
                        <td className="px-8 py-8 whitespace-nowrap text-right">
                          {desvio != null ? (
                            ...
                            <span className="text-[10px] font-black text-apple-gray-100 uppercase tracking-widest">Sin registro real</span>
                          )}
                        </td>
                        <td className="px-8 py-8 text-right whitespace-nowrap">
                          <Link
                            href={`/obras/${obraId}/ordenes-trabajo/${ot.id}`}
                            className="w-10 h-10 rounded-full bg-apple-gray-50 dark:bg-white/5 flex items-center justify-center text-apple-gray-300 hover:bg-apple-blue hover:text-white transition-all active:scale-90 group"
                          >
            ...
            <div className="bg-white dark:bg-apple-gray-50 rounded-[48px] p-24 text-center border border-apple-gray-100 dark:border-white/5 shadow-apple">
              ...
              <h3 className="text-3xl font-black text-foreground tracking-tighter uppercase italic mb-2">Central de Operaciones</h3>
        ...
        <div className="mt-12 text-center text-[10px] font-black text-apple-gray-100 uppercase tracking-[0.5em]">
