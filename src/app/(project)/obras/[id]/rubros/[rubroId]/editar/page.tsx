        ...
        <div className="flex items-center gap-6">
          ...
          <div className="space-y-1">
            <div className="flex items-center gap-3">
              ...
              <span className="text-[10px] font-bold text-apple-gray-400 uppercase tracking-widest">{obraNombre}</span>
            </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 relative z-10">
                  <div className="space-y-8">
                    <div className="flex items-center gap-4">
                      ...
                      <h3 className="text-lg font-black text-foreground tracking-tight uppercase">General</h3>
                    </div>
                  ...
                  <div className="space-y-8">
                    <div className="flex items-center gap-4">
                      ...
                      <h3 className="text-lg font-black text-foreground tracking-tight uppercase">Presupuesto</h3>
                    </div>
