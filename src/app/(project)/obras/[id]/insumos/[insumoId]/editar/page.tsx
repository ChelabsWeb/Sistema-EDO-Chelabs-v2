...
import { ArrowLeft, CheckCircle2, Loader2, Info, ChevronLeft, Save } from 'lucide-react'
  ...
  if (loading) {
    return (
      <div className="flex-1 flex flex-col items-center justify-center min-h-[50vh]">
        ...
        <p className="text-sm font-medium text-muted-foreground">Cargando Suministro...</p>
      </div>
    )
  }
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <Card>
             <CardHeader>
                ...
                <CardDescription>Modifica los campos necesarios para este insumo.</CardDescription>
             </CardHeader>
