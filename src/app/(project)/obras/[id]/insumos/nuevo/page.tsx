...
import { ArrowLeft, Package, Tag, DollarSign, CheckCircle2, Loader2, Info, Layers, Users } from 'lucide-react'
  ...
  if (loading) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-apple-gray-50/20 dark:bg-black/20 animate-pulse">
        ...
        <p className="text-[10px] font-black uppercase tracking-[0.2em] text-apple-gray-300">Preparando Suministros...</p>
      </div>
    )
  }
      ...
      <header className="fixed top-0 left-0 right-0 z-50 px-8 py-6 backdrop-blur-xl bg-white/70 dark:bg-apple-gray-50/70 border-b border-apple-gray-100 dark:border-white/5 shadow-apple-sm flex items-center justify-between">
        <div className="flex items-center gap-6">
          <Link
            ...
            className="w-10 h-10 rounded-full glass flex items-center justify-center text-apple-gray-400 hover:text-foreground transition-all active:scale-95 shadow-apple-sm"
          >
            <ArrowLeft className="w-5 h-5" />
          </Link>
          <div>
            <h1 className="text-xl font-black text-foreground tracking-tight">Nuevo Insumo</h1>
      ...
      <main className="max-w-3xl mx-auto pt-28 pb-20 animate-apple-slide-up">
        <form onSubmit={handleSubmit} className="space-y-10">
          ...
          <div className="bg-white dark:bg-apple-gray-50 rounded-[48px] p-10 border border-apple-gray-100 dark:border-white/5 shadow-apple-float space-y-12">
            ...
            <div className="space-y-3">
              ...
              <div className="relative group">
                <input
                  ...
                  className="w-full px-8 py-6 bg-apple-gray-50 dark:bg-black/20 rounded-[28px] border border-apple-gray-100 dark:border-white/10 focus:outline-none focus:border-apple-blue focus:ring-8 focus:ring-apple-blue/5 transition-all text-xl font-bold placeholder:text-apple-gray-100"
                  placeholder="Ej: Cemento Portland, Varilla 8mm..."
                />
                    ...
                    <button
                      ...
                      className={cn(
                        ...
                        formData.tipo === t
                          ...
                          : "text-apple-gray-300 hover:text-foreground"
                      )}
                    >
            ...
            {/* Info Message */}
            <div className="p-6 bg-apple-blue/5 dark:bg-apple-blue/10 rounded-[32px] border border-apple-blue/10 flex items-start gap-4">
              <Info className="w-6 h-6 text-apple-blue shrink-0" />
              <p className="text-xs text-apple-blue/80 font-medium leading-relaxed">
                Este insumo estará disponible para ser utilizado en cualquier <strong>Fórmula de Rubro</strong> dentro de esta obra. El precio de referencia se utilizará para estimar los costos globales.
              </p>
            </div>
            ...
            <div className="flex flex-col md:flex-row gap-4 pt-4">
              ...
              >
                ...
                {saving ? 'Registrando...' : 'Crear Insumo'}
              </button>
            </div>
          </div>
        </form>
